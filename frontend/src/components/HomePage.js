      ...
      <div className="homepage-content">
        ...
        <div className="left-column">
          ...
          <div className="create-section">
            ...
            <button className="create-mint-button" onClick={handleCreateMint}>
              Create Your Own Mint on NFT on opensea.io
            </button>
        ...
        <div className="right-column">
          <div className="about-section">
            <h2>About</h2>
            <p>
              <strong>stream-of-consciousness: An immersive metaverse art discovery engine curating off-chain and on-chain stories
              of every artwork ever created.</strong>
            </p>
            <p>
              Every artwork deserves comprehensive curation. Navigate through
              a river of information, discovering on-chain provenance and off-chain context
              that traditional platforms miss and get credited for contributions to awakening artworks.
            </p>
          </div>
        </div>
      </div>
